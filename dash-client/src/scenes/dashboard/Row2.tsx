    ...
    <>
      ...
      <DashboardBox gridArea="e">
        ...
        <FlexBetween mt="0.25rem" gap="1.5rem" pr="1rem">
          ...
          {/* flexBasis is a way of setting width in flexbox */}
          <Box ml="0.7rem" flexBasis="40%" textAlign="center">
            <Typography variant='h5'>Target Sales</Typography>
            <Typography m="0.3rem 0" variant='h3' color={palette.primary[300]}>83</Typography>
            <Typography variant='h6' color={palette.primary[300]}>Finance goals of the campaign that is desired</Typography>
          </Box>
          <Box flexBasis="40%">
